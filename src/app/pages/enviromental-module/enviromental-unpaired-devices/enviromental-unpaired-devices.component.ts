...
@Component({
  selector: 'app-enviromental-unpaired-devices',
  templateUrl: './enviromental-unpaired-devices.component.html',
  styleUrls: ['./enviromental-unpaired-devices.component.scss']
})
export class EnviromentalUnpairedDevicesComponent implements OnInit {
  ...
  ngOnInit(): void {
    // Setting the title
    this._titleUpdaterService.changeTitle("Dispositivos detectados");
